...
public class CellImage extends ImageView {
    /**
     * The constructor for the CellImage class. It creates a new CellImage with the given {@link Sprite spriteIndex}.
     * @param spriteIndex The sprite that represents the cell.
     */
